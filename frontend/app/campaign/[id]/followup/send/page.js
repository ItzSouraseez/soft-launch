        ...
        <div style={{ display: "flex", justifyContent: "center", margin: "1rem 0" }}>
          {job.status === "running" ? (
            ...
            <div style={{ color: "var(--accent-secondary)", display: "flex", alignItems: "center" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
            </div>
          ) : job.status === "aborted" ? (
            <div style={{ color: "var(--accent-orange)", display: "flex", alignItems: "center" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
            </div>
          ) : (
              ...
              {followups.map((fup) => {
                ...
                return (
                  <tr key={fup.id}>
                    ...
                    <td>
                      <span className={statusClass} style={{ display: "inline-flex", alignItems: "center", gap: "0.25rem" }}>
                    ...
                    <td style={{ fontSize: "0.85rem", color: "var(--text-secondary)" }}>
                      {fup.status === "sent" ? (
                        <div style={{ display: "flex", flexDirection: "column", gap: "0.15rem" }}>
                          <span style={{ fontSize: "0.75rem", fontFamily: "var(--font-mono)", color: "var(--accent-secondary)", display: "flex", alignItems: "center", gap: "0.25rem" }}>
